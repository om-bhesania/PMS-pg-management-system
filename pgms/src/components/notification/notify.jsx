            ...
            <div className="">
                ...
                <MenuList className="w-full p-4">
                    {notifications.length > 0 ? (
                        notifications.map((notification, index) => (
                            <div key={index}>
                                <Text className="text-lg font-bold text-primary pb-2 mb-2 border-b-2">Messages ({notification.messages.length})</Text>
                                {notification.messages.map((msg, idx) => (
                                    <>
                                        <MenuItem key={idx}>
                                            <Flex alignItems={'center'} justifyContent={'space-between'} gap={5}>
                                                <Text className="text-sm font-medium flex-shrink-0">{msg}</Text>  
                                            </Flex>
                                        </MenuItem>
                                    </>
                                ))
                        ...
                        <MenuItem>
                            <Text className="text-danger font-bold">No notifications found</Text>
                        </MenuItem>
                    )}
                </MenuList>
            </div>
